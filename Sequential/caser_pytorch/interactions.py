...
class Interactions(object):
    ...
    def to_sequence(self, sequence_length=50, target_length=1):
        """
        ...
        #print("2",sequences,sequences_targets,len(sequences),len(sequences_targets))
        ...
        #print("1",self.sequences,self.test_sequences)
